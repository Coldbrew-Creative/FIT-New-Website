...
<?php include("header.php") ?>
      ...
      <div class="col-md-12 text-center">
		 ...
		 <h3><font><center><i><b>Make your best impression with First Impression!</b></i></center></font></h3>
         <br>
         </div>
      </div>
      <!-- Services Section-->
               ...
               <div class="carousel-inner" role="listbox">
                  ...
                  <div class="item">
                     <div class="carousel-caption">
                        <div class="col-md-6">
                           <div class="col-md-10 col-md-offset-2 testimonial-text">
                              <p>"Decided to treat myself and my girls for some wine tasting for my birthday!  We booked the white hummer to take us to Morgan Hill for brunch and wineries!  Driver was on time and we were very impressed with the car. Everything was clean and we enjoyed beverages while getting to our destinations. We all had a great time and didn't have to worry about anything. Driver was very accommodating to our requests and location stops. Told us exactly where the car would be when we were ready for our next location.  Would recommend and use again."</p>
                              <h3>Nora A.</h3>
                           </div>
                        </div>
                        <div class="col-md-6">
